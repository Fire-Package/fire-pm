...
- `[2026-09-07]{00:24:30} Security Hardening: Add WebSocket Origin validation, restrict forwarded IP trust to loopback, verify regular files on download, cap uploads at 500MB, add dynamic Secure cookies, and relocate cloudflared binary #Issue 41`
